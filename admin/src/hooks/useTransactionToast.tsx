               ...
               <div className="mt-2">
                  ...
                  <div className="flex gap-2 w-full">
                     <Button
                        variant="outline"
                        size="sm"
                        className={`h-8 px-2 text-xs flex-1 cursor-pointer ${
                           isContentCopied
                              ? 'bg-purple-900/20 border-purple-500/50'
                              : 'bg-black/20 hover:bg-purple-900/20 hover:text-white border-purple-800/30'
                        }`}
                     ...
                     <Button
                        variant="outline"
                        size="sm"
                        className="h-8 px-2 text-xs flex-1 hover:text-white cursor-pointer bg-black/20 hover:bg-blue-900/20 border-blue-800/30"
                        onClick={(e) => {
                           e.stopPropagation()
